...
+ 機會類型{#opportunity-types}
  ...
  + {hide-from-toc}[表單最佳化](/help/opportunity-types/form-optimization.md)
  + {hide-from-toc}[表單無障礙](/help/opportunity-types/form-accesibility.md)
+ 文件{#documentation}
  ...
  + 機會{#opportunities}
    ...
    + [準備程式碼修補程式](/help/documentation/opportunities/preparing-code-patches.md)
    ...
    + {hide-from-toc}[表單低轉換率](/help/documentation/opportunities/low-conversions.md)
    + {hide-from-toc}[表單低瀏覽量](/help/documentation/opportunities/low-views.md)
    + {hide-from-toc}[表單低導覽行為](/help/documentation/opportunities/low-navigation.md)
    + {hide-from-toc}[Forms 無障礙問題](/help/documentation/opportunities/forms-accessibility-issues.md)
  ...
  + 預檢{#preflight}
    ...
    + 稽核{#preflight-audits}
      + [概觀](/help/documentation/preflight/audits.md)
      ...
      + 稽核類別{#preflight-opportunities}
        ...
        + SEO{#preflight-seo}
          ...
          + [後設標記](/help/documentation/preflight/opportunities/seo/metatags.md)
